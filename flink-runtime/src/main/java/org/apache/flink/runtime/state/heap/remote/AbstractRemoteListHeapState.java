 ...
 */
public abstract class AbstractRemoteListHeapState<K, N, SV> implements InternalKvState<K, N, SV> {

	private static final Logger LOG = LoggerFactory.getLogger(AbstractRemoteListHeapState.class);
	 ...
	 */
	public AbstractRemoteListHeapState(
		...
		this.sharedKeyNamespaceSerializer = sharedKeyNamespaceSerializer;
	}
	...
	public final void clear() {
		syncRemClient.del(serializeCurrentKeyWithGroupAndNamespace());
